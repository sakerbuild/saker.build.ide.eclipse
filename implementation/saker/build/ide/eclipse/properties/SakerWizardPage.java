...
public abstract class SakerWizardPage extends DialogPage implements IWizardPage {
	private IWizard wizard = null;

	private IWizardPage previousPage = null;

	protected SakerWizardPage() {
		this(null, (ImageDescriptor) null);
	}

	protected SakerWizardPage(String title, ImageDescriptor titleImage) {
